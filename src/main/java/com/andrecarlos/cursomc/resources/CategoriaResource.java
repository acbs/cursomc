...
import com.andrecarlos.cursomc.services.CategoriaService;
...
public class CategoriaResource {
	...
	// Primeiro ele irá executar a validação @Valid
	// @RequestBody converte o json para objeto java
	// <Void> retorna o corpo vazio
	@RequestMapping(method = RequestMethod.POST)
	//
	@PreAuthorize("hasAnyRole('ADMIN')") // Apenas o ADMIN terá autorização para acessar esse endpoint (Fazendo autorização por perfil)
